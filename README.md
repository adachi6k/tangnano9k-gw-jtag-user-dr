...
The working USER data register path on Tang Nano 9K is:
...
`drscan 32 0x0000003f` through ER2 lights all six on-board LEDs in the probe
top. See [`NOTES.md`](NOTES.md) for the bring-up notes and diagnostics.
