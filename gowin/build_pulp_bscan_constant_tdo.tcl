# build_pulp_bscan_constant_tdo.tcl — Batch synthesis and implementation for
# the PULP-style constant TDO probe on Tang Nano 9K using Gowin EDA.

set_device GW1NR-LV9QN88PC6/I5 -device_version C

add_file -type verilog {synth_defines.vh}

set _fp [open {../filelists/rtl_pulp_bscan_constant_tdo.f} r]
...
set_option -top_module pulp_bscan_constant_tdo_tangnano9k_top
...
set _fs_dst {impl/pnr/pulp_bscan_constant_tdo_tangnano9k_top.fs}
