# build_pulp_bscan_constant_tdo_primer20k.tcl

set_device GW2A-LV18PG256C8/I7 -device_version C

add_file -type verilog {synth_defines.vh}

set _fp [open {../filelists/rtl_pulp_bscan_constant_tdo_primer.f} r]
...
set_option -top_module pulp_bscan_constant_tdo_primer_top
...
set _fs_dst {impl/pnr/pulp_bscan_constant_tdo_primer20k.fs}
