# build_jtag_probe.tcl — Batch synthesis and implementation for the
# GW_JTAG USER DR probe on Tang Nano 9K using Gowin EDA.

set_device GW1NR-LV9QN88PC6/I5 -device_version C

add_file -type verilog {synth_defines.vh}

set _fp [open {../filelists/rtl_jtag_probe.f} r]
...
set_option -top_module jtag_user_reg_tangnano9k_top
...
set _fs_dst {impl/pnr/jtag_user_reg_tangnano9k_top.fs}
