# build_pulp_bscan_signal_tdo_primer25k.tcl

set_device -name GW5A-25A GW5A-LV25MG121NC1/I0

add_file -type verilog {synth_defines.vh}

set _fp [open {../filelists/rtl_pulp_bscan_signal_tdo_primer.f} r]
...
set_option -top_module pulp_bscan_signal_tdo_primer_top
...
set _fs_dst {impl/pnr/pulp_bscan_signal_tdo_primer25k.fs}
