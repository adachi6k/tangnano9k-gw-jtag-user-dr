# build_jtag_er1_diag.tcl — Batch synthesis and implementation for the
# GW_JTAG ER1 sticky-signal diagnostic top on Tang Nano 9K using Gowin EDA.

set_device GW1NR-LV9QN88PC6/I5 -device_version C

add_file -type verilog {synth_defines.vh}

set _fp [open {../filelists/rtl_jtag_er1_diag.f} r]
...
set_option -top_module jtag_diag_er1_tangnano9k_top
...
set _fs_dst {impl/pnr/jtag_diag_er1_tangnano9k_top.fs}
